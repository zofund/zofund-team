...
#    pos_dict=list(pos_dict["postive"].values)
#    neg_dict=list(neg_dict['negative'].values)
#    sent_dict = SentDict(docs,method="PMI",min_times=1,scale ="0-1",pos_seeds,neg_seeds)
