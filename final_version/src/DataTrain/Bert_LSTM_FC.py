...
MODEL_CLASSES = {
    "bert_model": (BertConfig, BertTokenizer),
}
...
path_saved_bert = {"model_name_or_path": SAVED_BERT_PATH,
                   "config_name": SAVED_BERT_PATH,
                   "tokenizer_name": SAVED_BERT_PATH,
                   }
...
class LongTxtBertMultiLearner:
    def __init__(
        ...
        _, tokenizer_class = MODEL_CLASSES["bert_model"]
    ...
    def from_pretrained_model(data, model_path):
        config_class, _ = MODEL_CLASSES["bert_model"]
